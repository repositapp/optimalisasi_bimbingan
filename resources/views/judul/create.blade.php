...
@section('content')
    ...
    <section class="content">
        <div class="box box-info">
            ...
            <div class="box-body">
                <form class="form-horizontal" action="{{ route('judul.store') }}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control @error('judul') is-invalid @enderror" rows="3" name="judul" id="judul">{{ old('judul') }}</textarea>
                            @error('judul')
                        ...
                        <div class="col-sm-10">
                            <select class="form-control select2 @error('mahasiswa_id') is-invalid @enderror"
                                ...
                                @foreach ($mahasiswa as $row)
                                    <option value="{{ $row->id }}"
                                        @if (old('mahasiswa_id') == $row->id) selected="selected" @endif>
                                        {{ $row->nama_mahasiswa }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-sm-10">
                            <select class="form-control select2 @error('pembimbing1_id') is-invalid @enderror"
                                ...
                                @foreach ($dosen as $row)
                                    <option value="{{ $row->id }}"
                                        @if (old('pembimbing1_id') == $row->id) selected="selected" @endif>
                                        {{ $row->nama_dosen }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control select2 @error('pembimbing2_id') is-invalid @enderror"
                                ...
                                @foreach ($dosen as $row)
                                    <option value="{{ $row->id }}"
                                        @if (old('pembimbing2_id') == $row->id) selected="selected" @endif>
                                        {{ $row->nama_dosen }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control select2 @error('penguji1_id') is-invalid @enderror" id="penguji1_id"
                                ...
                                @foreach ($dosen as $row)
                                    <option value="{{ $row->id }}"
                                        @if (old('penguji1_id') == $row->id) selected="selected" @endif>
                                        {{ $row->nama_dosen }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control select2 @error('penguji2_id') is-invalid @enderror" id="penguji2_id"
                                ...
                                @foreach ($dosen as $row)
                                    <option value="{{ $row->id }}"
                                        @if (old('penguji2_id') == $row->id) selected="selected" @endif>
                                        {{ $row->nama_dosen }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control select2 @error('penguji3_id') is-invalid @enderror"
                                ...
                                @foreach ($dosen as $row)
                                    <option value="{{ $row->id }}"
                                        @if (old('penguji3_id') == $row->id) selected="selected" @endif>
                                        {{ $row->nama_dosen }}
                                    </option>
                                @endforeach
                            </select>
