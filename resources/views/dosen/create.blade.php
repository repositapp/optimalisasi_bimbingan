                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('nidn') is-invalid @enderror" id="nidn"
                                name="nidn" value="{{ old('nidn') }}" placeholder="NIDN Dosen">
                            @error('nidn')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('nama_dosen') is-invalid @enderror"
                                id="nama_dosen" name="nama_dosen" value="{{ old('nama_dosen') }}" placeholder="Nama Dosen">
                            @error('nama_dosen')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control @error('alamat_dosen') is-invalid @enderror" rows="3" name="alamat_dosen"
                                id="alamat_dosen">{{ old('alamat_dosen') }}</textarea>
                            @error('alamat_dosen')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('pendidikan_terakhir') is-invalid @enderror"
                                ...
                                value="{{ old('pendidikan_terakhir') }}" placeholder="Pendidikan Terakhir">
