                        ...
                        <div class="col-sm-10">
                            <select class="form-control select2 @error('judul_id') is-invalid @enderror" id="judul_id"
                                ...
                                @foreach ($juduls as $row)
                                    <option value="{{ $row->id }}"
                                        @if (old('judul_id') == $row->id) selected="selected" @endif>
                                        {{ $row->judul }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-sm-10">
                            <div class="input-group date">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('tanggal_bimbingan', \Carbon\Carbon::parse(now())->translatedFormat('m/d/Y')) }}"
                        ...
                        <div class="col-sm-10">
                            <div class="input-group date">
                                ...
                                <input type="text"
                                    ...
                                    id="datepicker" name="waktu_mulai" value="{{ old('waktu_mulai') }}"
                        ...
                        <div class="col-sm-10">
                            <div class="input-group date">
                                ...
                                <input type="text"
                                    ...
                                    id="datepicker" name="waktu_selesai" value="{{ old('waktu_selesai') }}"
                                    placeholder="hh:mm am/pm">
                            </div>
                            @error('waktu_selesai')
                                <div class="invalid-feedback">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('topik_bimbingan') is-invalid @enderror"
                                id="topik_bimbingan" name="topik_bimbingan" value="{{ old('topik_bimbingan') }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control @error('status') is-invalid @enderror" id="status"
                                name="status">
                                <option value="" hidden>-- Choose --</option>
                                <option value="dijadwalkan" @if (old('status') == 'dijadwalkan') selected="selected" @endif>
                                    Dijadwalkan
                                </option>
                                <option value="selesai" @if (old('status') == 'selesai') selected="selected" @endif>
                                    Selesai
                                </option>
                                <option value="batal" @if (old('status') == 'batal') selected="selected" @endif>
                                    Batal
                                </option>
                            </select>
                            @error('status')
