                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('npm') is-invalid @enderror" id="npm"
                                name="npm" value="{{ old('npm', $mahasiswa->npm) }}" placeholder="NPM Mahasiswa">
                            @error('npm')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="form-control @error('jenis_kelamin') is-invalid @enderror" id="jenis_kelamin"
                                ...
                                <option value="Laki-Laki" @if (old('jenis_kelamin', $mahasiswa->jenis_kelamin) == 'Laki-Laki') selected="selected" @endif>
                                    Laki-Laki
                                </option>
                                <option value="Perempuan" @if (old('jenis_kelamin', $mahasiswa->jenis_kelamin) == 'Perempuan') selected="selected" @endif>
                                    Perempuan
                                </option>
                            </select>
                            @error('jenis_kelamin')
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control @error('alamat_mahasiswa') is-invalid @enderror" rows="3" name="alamat_mahasiswa"
                                id="alamat_mahasiswa">{{ old('alamat_mahasiswa', $mahasiswa->alamat_mahasiswa) }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                                name="email" value="{{ old('email', $mahasiswa->email) }}" placeholder="Email Aktif">
                            @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('telepon') is-invalid @enderror" id="telepon"
                                name="telepon" value="{{ old('telepon', $mahasiswa->telepon) }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control @error('kelas') is-invalid @enderror" id="kelas"
                                name="kelas" value="{{ old('kelas', $mahasiswa->kelas) }}" placeholder="Kelas">
                            @error('kelas')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
